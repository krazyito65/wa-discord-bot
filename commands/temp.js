    ...
    if (!sentAsCommand) {
        ...
        if (data) {
            ...
            if (containsTemp) {
                ...
                if (unit == 'f') {
                    botFuncs.sendMsg(channelID, "Temprature Conversioin: " + temp.toUpperCase() + " is equal to " + fToC(tempNumber) + "C");
                } else if (unit == 'c') {
                    botFuncs.sendMsg(channelID, "Temprature Conversioin: " + temp.toUpperCase() + " is equal to " + cToF(tempNumber) + "F");
                } else {
